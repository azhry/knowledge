					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="<?= base_url('kebagan/profile') ?>"><i class="lnr lnr-user"></i> Profile</a></li>
								<li><a href="<?= base_url('kebagan/sunting-password') ?>"><i class="fa fa-key"></i> Sunting Password</a></li>
