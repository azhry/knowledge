            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li><a href="<?= base_url('staff/daftar-pengetahuan-tacit') ?>" class=""><i class="lnr lnr-book"></i> <span>Tacit Knowledge</span></a></li></li>
                        <li><a href="<?= base_url('staff/daftar-pengetahuan-explicit') ?>" class=""><i class="lnr lnr-book"></i> <span>Explicit Knowledge</span></a></li></li>
